...
@NamedQueries({
    ...
    , @NamedQuery(name = "Alumnos.findByAlumno", query = "SELECT a FROM Alumnos a WHERE a.correo = :correo AND a.password = :password")})
public class Alumnos implements Serializable {
    ...
    public Alumnos(Integer id, String matricula, String nombre, String paterno, String materno, String telefono, String correo, String password) {
        this.id = id;
